...
export function TechnologyCard({ technology, isAdded, onAdd }: Props) {
  return (
    <div className="rounded-xl border border-gray-200 bg-white p-5 shadow-sm hover:shadow-md">
      ...
      <div className="mt-4 flex items-center gap-1">
        ...
        <span className="text-sm font-semibold">{technology.rating}</span>
      </div>
      ...
      <button
        ...
        className={`btn mt-4 w-full ${
          isAdded ? "btn-disabled" : "bg-gray-900 text-white hover:bg-gray-800"
        }`}
      >
        {isAdded ? (
          <>
